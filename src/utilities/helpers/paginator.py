...
class PageViewer(discord.ui.View):
    ...
    @discord.ui.button(
        emoji="<:first:910500659621691452>", style=discord.ButtonStyle.primary
    )
    ...
    @discord.ui.button(
        emoji="<:previous:910500672376561664>", style=discord.ButtonStyle.gray
    )
    ...
    @discord.ui.button(
        emoji="<:bluearrow:910500655548989491>", style=discord.ButtonStyle.gray
    )
    async def next_page(
        self, button: discord.ui.Button, interaction: discord.Interaction
    ):
    ...
    @discord.ui.button(
        emoji="<:last:910500662071160912>", style=discord.ButtonStyle.primary
    )
